...
1. **Identify targets** via WebSearch:
   ...
   - Assigned recruiter
   - 2-3 peers from the team (people with similar roles)
...
2. **Classify contact type** -- ask the candidate or infer from context:
   ...
   - **Hiring Manager** -- the person leading the team being hired
...
3. **Select primary target**: the person who would benefit most from the candidate being on the team
...
4. **Generate message** with 3-sentence framework adapted to contact type:
   ...
   - **Note**: Light tone, not desperate. The goal is to show you did your homework.
